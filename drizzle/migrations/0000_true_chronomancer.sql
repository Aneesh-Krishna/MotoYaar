...
ALTER TABLE "post_reports" ADD CONSTRAINT "post_reports_reporter_user_id_users_id_fk" FOREIGN KEY ("reporter_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vehicle_access" ADD CONSTRAINT "vehicle_access_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_invites" ADD CONSTRAINT "vehicle_invites_vehicle_id_vehicles_id_fk" FOREIGN KEY ("vehicle_id") REFERENCES "public"."vehicles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_invites" ADD CONSTRAINT "vehicle_invites_owner_user_id_users_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_invites" ADD CONSTRAINT "vehicle_invites_invitee_user_id_users_id_fk" FOREIGN KEY ("invitee_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_ai_reports_user_id" ON "ai_reports" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_ai_reports_monthly" ON "ai_reports" USING btree ("user_id","requested_at");--> statement-breakpoint
CREATE INDEX "idx_comments_post_id" ON "comments" USING btree ("post_id");--> statement-breakpoint
CREATE INDEX "idx_comments_parent_id" ON "comments" USING btree ("parent_comment_id");--> statement-breakpoint
CREATE INDEX "idx_documents_vehicle_id" ON "documents" USING btree ("vehicle_id");--> statement-breakpoint
CREATE INDEX "idx_documents_user_id" ON "documents" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_documents_expiry_date" ON "documents" USING btree ("expiry_date");--> statement-breakpoint
...
CREATE UNIQUE INDEX "post_reactions_post_id_user_id_unique" ON "post_reactions" USING btree ("post_id","user_id");--> statement-breakpoint
CREATE INDEX "idx_post_reports_post_id" ON "post_reports" USING btree ("post_id");--> statement-breakpoint
CREATE UNIQUE INDEX "post_reports_post_id_reporter_user_id_unique" ON "post_reports" USING btree ("post_id","reporter_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_posts_tags" ON "posts" USING btree ("tags");--> statement-breakpoint
CREATE INDEX "idx_push_subscriptions_user_id" ON "push_subscriptions" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "push_subscriptions_user_id_endpoint_unique" ON "push_subscriptions" USING btree ("user_id","endpoint");--> statement-breakpoint
...
CREATE INDEX "idx_vehicle_access_vehicle_id" ON "vehicle_access" USING btree ("vehicle_id");--> statement-breakpoint
CREATE INDEX "idx_vehicle_access_user_id" ON "vehicle_access" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "vehicle_access_vehicle_id_user_id_unique" ON "vehicle_access" USING btree ("vehicle_id","user_id");--> statement-breakpoint
CREATE INDEX "idx_vehicle_invites_vehicle_id" ON "vehicle_invites" USING btree ("vehicle_id");--> statement-breakpoint
CREATE INDEX "idx_vehicle_invites_token" ON "vehicle_invites" USING btree ("token");--> statement-breakpoint
CREATE INDEX "idx_vehicle_invites_invitee_email" ON "vehicle_invites" USING btree ("invitee_email");--> statement-breakpoint
CREATE INDEX "idx_vehicles_user_id" ON "vehicles" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "vehicles_user_id_registration_number_unique" ON "vehicles" USING btree ("user_id","registration_number");